<%@ Page Language="C#" AutoEventWireup="true" CodeFile="C_feedback_request.aspx.cs" Inherits="C_feedback_request" %>
...
<![endif]-->
    ...
    <style>
        .loader {
            ...
            height: 100%;
            z-index: 9999;
            background: url('gears.gif') 50% 50% no-repeat rgb(128, 128, 128);
            opacity: .9;
        }
    </style>
        ...
        <div>
            ...
            <div class="panel panel-default timeline-appointments">
                <div class="panel-heading">
                    <div class="pull-left">
                        <a href="#" class="btn btn-primary">Feedback of Requested Candidate</a>
                    </div>
                    <br />
